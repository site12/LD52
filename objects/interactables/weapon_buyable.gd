...
@export var upgrade_prices = [0, 1000, 4000]

@export var hoe_rust = preload("res://objects/weapons/mats/hoe_tool_rust.tres")
@export var hoe_iron = preload("res://objects/weapons/mats/hoe_tool_iron.tres")
@export var hoe_silver = preload("res://objects/weapons/mats/hoe_tool_silver.tres")

@export var upgrade_levels = [hoe_rust, hoe_iron, hoe_silver]
